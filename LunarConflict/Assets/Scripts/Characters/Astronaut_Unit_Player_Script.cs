...
public class Astronaut_Unit_Player_Script : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        HP = max_HP;
        speed = Units_Statistics.astronaut_speed + TEMP;
    }
    ...
    private void Update()
    {
        ...
        {
            if (x.collider.CompareTag("EnemyUnit") && x.collider.gameObject != gameObject)
            {
